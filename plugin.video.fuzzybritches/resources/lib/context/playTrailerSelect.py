...
if __name__ == '__main__':
	...
	xbmc.executebuiltin('RunPlugin(plugin://plugin.video.fuzzybritches/?action=play_Trailer_Select&type=%s&name=%s&year=%s&windowedtrailer=0,return)' % (type, name, year))