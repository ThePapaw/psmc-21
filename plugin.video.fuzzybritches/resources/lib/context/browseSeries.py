...
if __name__ == '__main__':
	...
	xbmc.executebuiltin('ActivateWindow(Videos,plugin://plugin.video.fuzzybritches/?action=seasons&tvshowtitle=%s&year=%s&imdb=%s&tmdb=%s&tvdb=%s&art=%s,return)' % (systvshowtitle, year, imdb, tmdb, tvdb, sysart))