...
class ProgressScrape(BaseDialog):
	...
	def set_controls(self):
		...
		if self.meta:
			...
			if self.meta.get('fanart'): self.setProperty('fuzzybritches.fanart', self.meta.get('fanart'))
		...
		self.setProperty('fuzzybritches.sourceshighlight.color', self.source_color)
