...
class yt_index:  # initializes as musicvids, functions can override based on action and subid.
	def __init__(self):
		...
		self.base_url = 'https://raw.githubusercontent.com/fuzzybritchesplug/fuzzybritchesplug.github.io/master/matrix/xml/youtube/'
		self.mainmenu = self.base_url + 'musicvids.txt'
		self.submenu = '%s/%s.txt'
		self.default_icon = '%s/icons/music_video_folder_icon.gif'
