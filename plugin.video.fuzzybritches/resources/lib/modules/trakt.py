	...
	try:
		...
		if select >= 0:
			if items[select][1] == 'watch':
				...
				control.execute('RunPlugin(plugin://plugin.video.fuzzybritches/?action=shows_traktHiddenManager)')
			elif items[select][1] == 'unfinishedEpisodeManager':
				control.execute('RunPlugin(plugin://plugin.video.fuzzybritches/?action=episodes_traktUnfinishedManager)')
...
def traktClientID():
	traktId = 'b01d16e2125edafdcc4ff892531420362b2d9ed58da1f8f7f55d18cd040c6cbc'
...
def traktClientSecret():
	traktSecret = '2b0d129ca811380287e74f0fab99f88c4d3c6ea475f0f113297ae02f995f6b30'
