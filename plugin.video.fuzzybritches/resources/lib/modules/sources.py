# -*- coding: utf-8 -*-
"""
	FuzzyBritches Add-on Updated 10-6-24
"""
...
#					Sources(all_providers='true', rescrapeAll='true').play(title, year, imdb, tmdb, tvdb, season, episode, tvshowtitle, premiered, self.meta, select=select, rescrape='true')
	...
	def getConstants(self):
		...
		self.seasonProperty = 'plugin.video.fuzzybritches.container.season'
		self.episodeProperty = 'plugin.video.fuzzybritches.container.episode'
		self.titleProperty = 'plugin.video.fuzzybritches.container.title'
		self.imdbProperty = 'plugin.video.fuzzybritches.container.imdb'
		self.tmdbProperty = 'plugin.video.fuzzybritches.container.tmdb'
		self.tvdbProperty = 'plugin.video.fuzzybritches.container.tvdb'
		self.labelProperty = 'plugin.video.fuzzybritches.container.label'
