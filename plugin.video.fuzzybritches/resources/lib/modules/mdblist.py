# -*- coding: utf-8 -*-
# By FuzzyBritches for FuzzyBritches (07/18/22)
"""
...
_CLIENT_ID = 'mIQs8unE0osa80VGaaczWXiNrr1dBT46nlMccQWc'
...
def mdblistAuth(fromSettings=0):
	try:
		...
		if response.status_code != 200:
			...
			if fromSettings: control.openSettings('5.4', 'plugin.video.fuzzybritches')
			return False
