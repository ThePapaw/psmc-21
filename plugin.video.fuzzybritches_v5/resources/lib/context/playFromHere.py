...
if __name__ == '__main__':
	...
	xbmc.executebuiltin('RunPlugin(plugin://plugin.video.fuzzybritches_v5/?action=play_EpisodesList&tvshowtitle=%s&year=%s&imdb=%s&tmdb=%s&tvdb=%s&meta=%s&season=%s&episode=%s,return)' % (systvshowtitle, year, imdb, tmdb, tvdb, sysmeta, season, episode))