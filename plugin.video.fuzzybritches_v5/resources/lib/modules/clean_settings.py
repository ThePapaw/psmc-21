# -*- coding: utf-8 -*-
"""
	FuzzyBritches Add-on Modified by FuzzyBritches 1/2/23 to use minidom instead of element tree. we adapt.
"""
...
def clean_settings():
	...
	try:
		...
		addon = control.addon('plugin.video.fuzzybritches_v5')
