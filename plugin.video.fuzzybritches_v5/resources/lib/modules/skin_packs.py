# -*- coding: utf-8 -*-
"""
	FuzzyBritches Add-on (added by FuzzyBritches Dev 01/07/23 Updated 1/21/23)
"""
...
class iconPackHandler:
	...
	def get_skin_packs(self):
		...
		try:
			import requests
			repo_xml = requests.get('https://raw.githubusercontent.com/fuzzybritchesplug/fuzzybritchesplug.github.io/master/matrix/xml/skinpack/Skins.xml')
	...
	def set_active_skin_pack(self, skinpack):
		...
		control.openSettings('0.0', 'plugin.video.fuzzybritches_v5')
