...
#					Sources(all_providers='true', rescrapeAll='true').play(title, year, imdb, tmdb, tvdb, season, episode, tvshowtitle, premiered, self.meta, select=select, rescrape='true')
	...
	def getConstants(self):
		self.metaProperty = 'plugin.video.fuzzybritches_v5.container.meta'
		self.seasonProperty = 'plugin.video.fuzzybritches_v5.container.season'
		self.episodeProperty = 'plugin.video.fuzzybritches_v5.container.episode'
		self.titleProperty = 'plugin.video.fuzzybritches_v5.container.title'
		self.imdbProperty = 'plugin.video.fuzzybritches_v5.container.imdb'
		self.tmdbProperty = 'plugin.video.fuzzybritches_v5.container.tmdb'
		self.tvdbProperty = 'plugin.video.fuzzybritches_v5.container.tvdb'
		self.labelProperty = 'plugin.video.fuzzybritches_v5.container.label'
